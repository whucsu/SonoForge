...
- **Суть:**
  ...
  3. **Card layout**: таблица параметров заменена на карточки (`_ParameterCard`) с mini-таблицами норм и патологий; единицы измерения встроены в значения; колонка «Ед. изм.» убрана.
